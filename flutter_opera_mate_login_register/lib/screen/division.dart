...
class _DivisionState extends State<Division> {
  ...
  // agregar variable para controlar formula
    ...
    if (_formkey.currentState?.validate() ?? false) {
      ...
      setState(() {
        if (number2 != 0) {
          ...
          _resultado = 0.0; // o cualquier otro valor que desees para indicar error
        }
      });
    }
  }
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                keyboardType: TextInputType.number, // solo recibe numeros
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'Didite un valor numerico';
                  }
